...
class LinkController extends Controller
{
    ...
    public function store(LinkRequest $request)
    {
        ...
        return redirect()->route('clients.links.index')->with('success', __('messages.created', ['item' => __('dashboard.link')]));
    }
    ...
    public function update(LinkRequest $request, $id)
    {
        ...
        return redirect()->route('clients.links.index')->with('success', __('messages.updated', ['item' => __('dashboard.link')]));
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => __('messages.deleted', ['item' => __('dashboard.link')]),
        ]);
    }
}
