...
class LanguageController extends Controller
{
    ...
    public function store(LanguageRequest $request)
    {
        ...
        return redirect()->route('clients.languages.index')->with('success', __('messages.created', ['item' => __('dashboard.language')]));
    }
    ...
    public function update(LanguageRequest $request, $id)
    {
        ...
        return redirect()->route('clients.languages.index')->with('success', __('messages.updated', ['item' => __('dashboard.language')]));
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => __('messages.deleted', ['item' => __('dashboard.language')]),
        ]);
    }
}
