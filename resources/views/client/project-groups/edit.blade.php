...
@section('title', __('dashboard.edit_project_group'))
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
  @include('partials.page-intro', ['title' => __('dashboard.edit_project_group'), 'description' => __('dashboard.intros.project_group_form')])
  <div class="card">
    <div class="card-body">
