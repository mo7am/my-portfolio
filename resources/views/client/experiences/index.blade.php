...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Experiences </span></h4>

    <!-- DataTable with Buttons -->
    <div class="card">
      <div class="card-datatable table-responsive pt-0">
        <table class="datatables-basic table" id="experience_table">
          <thead>
            <tr>
              <th>Title</th>
              <th>Description</th>
...
$(document).ready(function(){
  ...
  $('#experience_table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "{{ route('clients.experiences.index') }}",
    },
    columns: [
        ...
        render: function (data, type, full, meta) {
          ...
          return `
            ...
            <a href="javascript:;" 
              ...
              data-url="${deleteUrl}" 
              data-title="Are you sure you want to delete experience (${full.title}) ?" 
              data-message="You can not undo this step!" 
              data-table="experience_table" 
              title="Delete">
    ...
    buttons: [
      ...
      },
      {
        ...
        action: function (e, dt, node, config) {
          window.location.href = "{{ route('clients.experiences.create') }}";
        }
      }
    ],
    responsive: {
  ...
  $('div.head-label').html('<h5 class="card-title mb-0">Experiences</h5>');
});
</script>
@endsection
