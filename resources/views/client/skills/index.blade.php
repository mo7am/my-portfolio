...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Skills </span></h4>

    <!-- DataTable with Buttons -->
    <div class="card">
      <div class="card-datatable table-responsive pt-0">
        <table class="datatables-basic table" id="skill_table">
          <thead>
            <tr>
              <th>Skill</th>
              <th>Action</th>
...
$(document).ready(function(){
  ...
  $('#skill_table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "{{ route('clients.skills.index') }}",
    },
    columns: [
        ...
        render: function (data, type, full, meta) {
          ...
          return `
            ...
            <a href="javascript:;" 
              ...
              data-url="${deleteUrl}" 
              data-title="Are you sure you want to delete skill (${full.skill}) ?" 
              data-message="You can not undo this step!" 
              data-table="skill_table" 
              title="Delete">
    ...
    buttons: [
      ...
      },
      {
        ...
        action: function (e, dt, node, config) {
          window.location.href = "{{ route('clients.skills.create') }}";
        }
      }
    ],
    responsive: {
  ...
  $('div.head-label').html('<h5 class="card-title mb-0">Skills</h5>');
});
</script>
@endsection
