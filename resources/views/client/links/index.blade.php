...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Links </span></h4>

    <!-- DataTable with Buttons -->
    <div class="card">
      <div class="card-datatable table-responsive pt-0">
        <table class="datatables-basic table" id="link_table">
          <thead>
            <tr>
              <th>Icon</th>
              <th>Color</th>
...
$(document).ready(function(){
        ...
        render: function (data, type, full, meta) {
          ...
          return `
            ...
            <a href="javascript:;" 
              ...
              data-url="${deleteUrl}" 
              data-title="Are you sure you want to delete link (${full.link}) ?" 
    ...
    buttons: [
      ...
      },
      {
        ...
        action: function (e, dt, node, config) {
          window.location.href = "{{ route('clients.links.create') }}";
        }
      }
    ],
    responsive: {
  ...
  $('div.head-label').html('<h5 class="card-title mb-0">Links</h5>');
});
</script>
@endsection
