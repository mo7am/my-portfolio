...
$(document).ready(function(){
  ...
  $('#user_table').DataTable({
    ...
    columns: [
          ...
          {data: 'portfolio_link', name: 'portfolio_link'},
    ...
    columnDefs: [
      {
        ...
        render: function (data, type, full, meta) {
          let editUrl = "{{ route('admins.users.edit', ':id') }}".replace(':id', full.id);
          let deleteUrl = "{{ route('admins.users.destroy', ':id') }}".replace(':id', full.id);
          ...
          return `
            ...
            <a href="javascript:;" 
              ...
              data-url="${deleteUrl}" 
              data-title="Are you sure you want to delete user (${full.name}) ?" 
    ...
    buttons: [
      ...
      },
      {
        ...
        action: function (e, dt, node, config) {
          window.location.href = "{{ route('admins.users.create') }}";
        }
      }
    ],
    responsive: {
